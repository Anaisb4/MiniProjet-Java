...
class BookCellRenderer extends JLabel implements ListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList list, Object value,
        ...
        strBlder.append("<html>");
        strBlder.append("Client n°: 0251260680 &nbsp;&nbsp;&nbsp;  LACOUR Henri");
        strBlder.append("<br>");
        strBlder.append("Tel: 0619506806 &nbsp;&nbsp;&nbsp;  Mail: lacourhenri@hotmail.fr");
        strBlder.append("</html>");

        setText(strBlder.toString());
